...
6. **Defenderプラン** の状態を確認し、変更する場合は **「保存」** をクリックします。

7. 設定領域から「**自動プロビジョニング**」を選択します。

8. 自動プロビジョニング-拡張機能を確認します。**Azure VM の Log Analytics エージェント/Azure VM の Azure Monitor エージェント (プレビュー)** を **オフ** にして、**「Continue」** をクリックします。

9. **Defenderプラン** の状態を確認し、**「保存」** をクリックします。
