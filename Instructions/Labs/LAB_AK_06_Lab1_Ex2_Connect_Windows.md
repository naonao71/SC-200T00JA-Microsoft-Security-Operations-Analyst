...
7. **Microsoft Windows10** の**作成**ドロップダウンを選択します。  次に、「**Windows 10 Enterprise, version 21H2**」を選択し、**事前設定された構成で開始する** をクリックします。
...
22. 「データコレクター」で「AMA を使用した Windows セキュリティ イベント」を選択します。
...
### タスク 4: Microsoft Defender for Endpoint ディバイスをオンボードする。
