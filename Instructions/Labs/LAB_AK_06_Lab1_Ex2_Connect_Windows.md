...
15. 「管理」タブで、「**Automanageを有効にする**」のチェックを外します。
...
3. 「コンテンツハブ」で、検索ウインドウに「Windows Security Events」を入力し、「Windows Security Events」を選択します。

4. コネクタ情報ブレードで「インストール」を選択します。

5. コネクタ情報ブレードで「管理」を選択します。

6. 「**Windows Security Events via AMA**」を選択します。

7. コネクタ情報ブレードで「**コネクタページを開く**」を選択します。「データ収集ルールの作成」をクリックします。

8. 「**ルール名**」に、「**AZWIN01DCR**」を入力します。

9. 「**次：リソース**」をクリックします。

10. 「**リソースの追加**」をクリックします。

11. スコープの **rg-AZWIN01** を展開し、**AZWIN01** 仮想マシンを選択し、「**適用**」をクリックします。

12. 「**次：収集**」をクリックして、「**次：確認と作成**」をクリックします。

13. 「**作成**」をクリックします。

14. 数分待って、「最新の情報に更新」をクリックし、データ収集ルールがリストされたことを確認します。
